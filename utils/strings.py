STRINGS = {
    'ar': {
        ...
        'choose_provider': "📶 اختر المزود (السيرفر) المناسب:",
        'countries_error': "❌ فشل في جلب قائمة الدول.",
        'creating_acc': "⏳ جاري البدء في إنشاء الحساب...",
        'status_bought': "📞 Number: `{phone}`\n💰 Price: `${price}`\n📶 Provider: `{provider}`\n💬 Code: جاري الطلب...",
        'status_requesting': "📞 Number: `{phone}`\n💰 Price: `${price}`\n📶 Provider: `{provider}`\n💬 Code: 📲 جاري طلب الكود...",
        'status_email_created': "📞 Number: `{phone}`\n💰 Price: `${price}`\n📶 Provider: `{provider}`\n📧 Email: `{email}`\n💬 Code: 📩 Waiting...",
        'status_email_success': "📞 Number: `{phone}`\n💰 Price: `${price}`\n📶 Provider: `{provider}`\n📧 Email: `{email}`\n💬 Code: ✅ تم التأكيد!",
        'status_waiting': "📞 Number: `{phone}`\n💰 Price: `${price}`\n📶 Provider: `{provider}`\n💬 Code: ⏳ Waiting... ({attempt}/{total})",
